...
def load_gui(self):
    ...
    self.btn_search.grid(row=0,column=2, columnspan = 2, padx=(15,0),pady=(15,30))
    ...
    self.btn_destination.grid(row=4, column=2, columnspan = 2, padx=(15, 0), pady=(15, 30))
